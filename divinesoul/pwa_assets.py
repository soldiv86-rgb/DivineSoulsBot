...
const CACHE_NAME = "ds-dashboard-v7";
        ...
        <div id="scriptView" class="hidden">
          <div class="bg-card border border-borderc rounded-2xl p-4">
            <div class="flex items-center justify-between gap-2 mb-2">
              <h2 class="text-base font-bold m-0">Roblox reporter script</h2>
            ...
            <p class="text-xs text-muted mb-3">Paste into ServerScriptService as a Script and enable HttpService in Game Settings &rarr; Security. It contains your report secret, so don't share it.</p>
            <pre id="scriptBox" class="bg-bgmain border border-borderc rounded-lg p-3 text-[11.5px] leading-snug overflow-x-auto whitespace-pre text-text m-0"></pre>
...
async function loadScript() {
  ...
  try {
    ...
    scriptLoaded = true;
    status.textContent = data.publicBaseUrlSet
      ? ""
      : "PUBLIC_BASE_URL isn't set on the server, so the report URL was taken from this page's address (" + data.baseUrl + ").";
  } catch (e) {
    box.textContent = "";
    scriptLoaded = false;
